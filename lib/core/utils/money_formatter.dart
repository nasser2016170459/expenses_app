...
class MoneyFormatter extends TextInputFormatter {
  ...
  MoneyFormatter({this.decimalDigits = 2}) : assert(decimalDigits >= 0);

  static String format(double? value) => value == null ? "" : NumberFormat("#,##0.##").format(value);

  static double? parse(String value) => double.tryParse(value.replaceAll(",", ""));

  static String asFormattedString(String value) {
    final doubleVal = parse(value);
    return format(doubleVal);
  }
